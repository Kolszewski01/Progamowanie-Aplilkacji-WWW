...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $update_stmt->bind_param("sssdidsissi", $tytul, $opis, $data_wygasniecia, $cena_netto, $podatek_vat, $ilosc_dostepnych_sztuk, $status_dostepnosci, $kategoria, $gabaryt_produktu, $zdjecie, $produkt_id);
...
<form method="POST" >
    ...
    <input type="text" id="zdjecie" name="zdjecie" style="width: 500px;" value="<?php echo htmlspecialchars($produkt_data['zdjecie']); ?>"><br>
